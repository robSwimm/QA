...
1. Remove option 'Leave workspace' (Admin role) <https://app.clickup.com/t/3723701/SWM-38305>
...
2. Welcome screen&nbsp;
   ...
   1. Remove buttons 'add users' , users icon (top left) - 5 places to remove&nbsp;&nbsp;
      ...
      <p align="center"><img src="/.swm/images/Screenshot%202025-09-30%20at%2018.19.25-2025-8-30-15-20-8-552.png"></p>

   2. when you collapse the menu&nbsp;

      <p align="center"><img src="/.swm/images/Screenshot%202025-09-30%20at%2018.44.17-2025-8-30-15-44-41-624.png" style="width: 10%"></p>
...
4. Make **Profile information** read only (Admin and member roles)&nbsp;
...
6. Improve group tab&nbsp;&nbsp;
   ...
   1. Option to edit group role after it was added&nbsp;
   2. Multi select when adding groups&nbsp;

7. &nbsp;Remove billing and plans <https://app.clickup.com/t/3723701/SWM-38183>

8. Remove the option to request to join to a workspace <https://app.clickup.com/t/3723701/SWM-38307>

9. Redirect users  to the relevant workplace when connecting VIA SCIM <https://app.clickup.com/t/3723701/SWM-38306>
